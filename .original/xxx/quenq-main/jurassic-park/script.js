...
function alarm() {
	...
	if (a == sound * 5) {
		...
		document.getElementById("yellowTableMiddle").innerHTML = "<div>Dilophosaurus Paddock</div><div>Quadrant Pranx power failure</div>";
	...
	if (a == 125) {
		a = -1;
		window.location.replace("https://www.quenq.com/jurassic-park/console/");
	}
